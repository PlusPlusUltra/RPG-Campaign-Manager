...
When /^(?:|I )follow "Downgrade User"$/ do |link, id|
  click_link(button, 2)
end
...
Given /^I am a registered user$/ do
  User.create!({:uid => 1, :email => "perottofederico@gmail.com", :username => "optest", :password => "12345678", :password_confirmation => "12345678" })
end
...
Given /^there's another user$/ do
  User.create!({:uid => 2, :email => "miserveunamailpertest@gmail.com", :username => "MarioBiondi", :password => "12345678", :password_confirmation => "12345678" })
end

Given /^he logs in$/ do
  steps %Q{
    Given I am on the login page
    When I fill in "Email" with "miserveunamailpertest@gmail.com"
    And I fill in "Password" with "12345678"
    And I press "Login"
    Then I should be on the home page
    And I should see "Logout"
...
When /^I create a Character (.*)$/ do |title|
  steps %Q{
    When I follow "My Characters"
    And I follow "Create New Character"
    And I fill in "Name" with #{title}
...
When /^I create a Campaign (.*)$/ do |title|
  steps %Q{
